#%matplotlib notebook #used only in jupyter notebook
import os
...
x = Conv2D(288, kernel_size=1, activation='relu')(input1)
x = Conv2D(144, kernel_size=1, activation='relu')(x)
x = MaxPooling2D(pool_size=(2, 2))(x)
x = Dropout(0.2)(x)

x = Conv2D(144, kernel_size=7, padding='same' ,activation='relu',)(x)
x = Conv2D(144, kernel_size=7, padding='same' ,activation='relu',)(x)
x = MaxPooling2D(pool_size=(2, 2))(x)
x = Dropout(0.2)(x)

x = Conv2D(144, kernel_size=5, padding='same' ,activation='relu',)(x)
x = Conv2D(144, kernel_size=5, padding='same' ,activation='relu',)(x)
x = MaxPooling2D(pool_size=(2, 2))(x)
x = Dropout(0.2)(x)

x = Conv2D(144, kernel_size=3, padding='same' ,activation='relu',)(x)
x = Conv2D(144, kernel_size=3, padding='same' ,activation='relu',)(x)
x = MaxPooling2D(pool_size=(2, 2))(x)
x = Dropout(0.5)(x)
