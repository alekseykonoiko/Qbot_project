...
mat_contents = sio.loadmat('trimmed_data/image_5per_trimmed.mat') #loads .mat file
...
mat_contents = sio.loadmat('trimmed_data/image_10per_trimmed.mat') #loads .mat file
image_data10=mat_contents['X10_trimmed'] #extracts data from .mat file
print ('10% water image shape', image_data10.shape)

mat_contents = sio.loadmat('trimmed_data/image_15per_trimmed.mat') #loads .mat file
