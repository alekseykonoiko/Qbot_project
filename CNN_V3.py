...
l1 = Conv3D(128, kernel_size=(1, 1, 36), strides=(1, 1, 9), activation='relu', kernel_initializer=initializer)(concat)
noise1 = GaussianNoise(0.01)(l1)
l2 = Conv3D(128, kernel_size=(1, 1, 36), padding='same', activation='relu', kernel_initializer=initializer)(noise1)
noise2 = GaussianNoise(0.01)(l2)
l3 = Conv3D(128, kernel_size=(1, 1, 36), padding='same', activation='relu', kernel_initializer=initializer)(noise2)
noise3 = GaussianNoise(0.005)(l3)
add1 = add([l1, noise3])

l4 = Conv3D(128, kernel_size=(1, 1, 18), strides=(1, 1, 6), activation='relu', kernel_initializer=initializer)(add1)
noise4 = GaussianNoise(0.005)(l4)
l5 = Conv3D(128, kernel_size=(1, 1, 18), padding='same',activation='relu', kernel_initializer=initializer)(noise4)
...
l7 = Conv3D(128, kernel_size=(1, 1, 3), activation='relu', kernel_initializer=initializer)(add2)
noise7 = GaussianNoise(0.005)(l7)
drop1 = SpatialDropout3D(0.2)(noise7)
l8 = Conv3D(128, kernel_size=(1, 1, 3), activation='relu', kernel_initializer=initializer)(drop1)
